...
namespace Mute.Tests.Extensions
{
    ...
    public class IReadOnlyDictionaryExtensionsTests
    {
        ...
        {
            IReadOnlyDictionary<string, object?> dict = new Dictionary<string, object?> { ["key"] = new string?[] { "a", "b", "c" } };

            var success = dict.GetToolParameterStringArray("key", out var result, out var err);

            Assert.IsTrue(success);
            Assert.IsNotNull(result);
            CollectionAssert.AreEqual(new string?[] { "a", "b", "c" }, result);
            Assert.IsNull(err);
        }
        ...
        public void GetToolParameterStringArray_ListOfStrings_ReturnsArray()
        {
            ...
            Assert.IsTrue(success);
            Assert.IsNotNull(result);
            CollectionAssert.AreEqual(new string?[] { "x", "y" }, result);
            Assert.IsNull(err);
        }
        ...
        {
            IReadOnlyDictionary<string, object?> dict = new Dictionary<string, object?> { ["key"] = new float[] { 1.0f, 2.0f, 3.0f } };

            var success = dict.GetToolParameterFloatArray("key", out var result, out var err);

            Assert.IsTrue(success);
            Assert.IsNotNull(result);
            CollectionAssert.AreEqual(new float[] { 1.0f, 2.0f, 3.0f }, result);
            Assert.IsNull(err);
        }
        ...
        public void GetToolParameterFloatArray_ListOfFloats_ReturnsArray()
        {
            ...
            Assert.IsTrue(success);
            Assert.IsNotNull(result);
            CollectionAssert.AreEqual(new float[] { 4.0f, 5.0f }, result);
            Assert.IsNull(err);
        }
        ...
        {
            IReadOnlyDictionary<string, object?> dict = new Dictionary<string, object?> { ["key"] = new int[] { 10, 20, 30 } };
        ...
        {
            IReadOnlyDictionary<string, object?> dict = new Dictionary<string, object?> { ["key"] = new bool[] { true, false, true } };

            var success = dict.GetToolParameterBoolArray("key", out var result, out var err);

            Assert.IsTrue(success);
            Assert.IsNotNull(result);
            CollectionAssert.AreEqual(new bool[] { true, false, true }, result);
            Assert.IsNull(err);
        }
        ...
        public void GetToolParameterBoolArray_ListOfBools_ReturnsArray()
        {
            ...
            Assert.IsTrue(success);
            Assert.IsNotNull(result);
            CollectionAssert.AreEqual(new bool[] { false, true }, result);
            Assert.IsNull(err);
        }
