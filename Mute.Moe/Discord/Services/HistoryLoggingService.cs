...
namespace Mute.Moe.Discord.Services
{
    public class HistoryLoggingService
    {
        ...
        [NotNull] public MessagesResult MessagesByUser([NotNull] IUser user)
        {
        ...
        [NotNull] public MessagesResult MessagesByTimeRange(DateTime min, DateTime max)
        {
            var cmd = _database.CreateCommand();
        ...
        [NotNull] public MessagesResult MessagesByContent(string word)
        {
            var cmd = _database.CreateCommand();
