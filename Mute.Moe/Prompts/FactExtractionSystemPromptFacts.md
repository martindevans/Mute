...
## Fact Isolation
- Every extracted fact MUST explicitly name the entities it refers to.
- NEVER use pronouns ("it", "this", "that", "they", "he", "she") in extracted facts.
- If a fact depends on another fact to be understood, MERGE them into a single statement.
- If the entity cannot be unambiguously named, DO NOT EXTRACT the fact.
